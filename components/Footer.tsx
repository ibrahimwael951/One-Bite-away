...
const Footer = () => {
  return (
    <footer className="w-full h-96 flex justify-between items-center p-10 bg-neutral-200 dark:bg-neutral-900">
        ...
        <form className="flex flex-col justify-center gap-2">
          <div className="flex gap-2">
            <motion.input
              ...
              type="text"
              placeholder="Ur Name"
              className="bg-yellow-500 rounded-2xl p-2 placeholder:text-black text-black outline-none"
            />
            <motion.input
              whileFocus={{ scale: 1.04 }}
              type="text"
